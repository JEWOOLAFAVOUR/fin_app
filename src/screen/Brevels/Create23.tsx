  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        {/* Continued description from previous screen */}
        <Text style={styles.continuedText}>
          cardio and muscular exertion throughout the day. It resets at
          midnight.
        </Text>
        ...
        {/* How Strain is calculated Section - Extended */}
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.calculationItem}>
            ...
            <View style={styles.calculationText}>
              ...
              <Text style={styles.calculationDescription}>
                Data associated strength training sessions (i.e. motion data,
                weights, reps, sets).
              </Text>
            </View>
          </View>
          ...
          <View style={styles.calculationItem}>
            <Text style={styles.calculationIcon}>🚶</Text>
            <View style={styles.calculationText}>
              <Text style={styles.calculationTitle}>Passive strain</Text>
              <Text style={styles.calculationDescription}>
                HR data from activities that are not recorded (i.e. walking to
                the grocery store).
              </Text>
            </View>
          </View>
      ...
      <View style={styles.navigationContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            (navigation as any).navigate("Create24");
          }}
        >
